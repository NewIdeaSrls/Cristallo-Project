...
export class AgentsComponent implements OnInit {
  ...
  datacolumns = ['agentCode', 'agentDescription', 'agentEmail', 'agentPhone', 'agentType'];
  dataconfig = ['add', 'search', 'columns', 'reload'];

  datashow = ['agentCode', 'agentDescription', 'agentEmail', 'agentPhone', 'agentType'];

  localStorageMDTable: string = 'agentTable';
  // Configure Fields on Action in accounting
  addfieldsconfig = ['agentCode', 'agentDescription', 'agentEmail', 'agentPhone', 'agentType'];
  editfieldsconfig = ['agentCode', 'agentDescription', 'agentEmail', 'agentPhone', 'agentType'];
  ...
  getFromRestapi(
    ...
    this.globalService
      ...
      .subscribe((Agents: any) => {
        console.log('agent data: ', Agents['data']);
        console.log('agent length: ', Agents['data'].length);
