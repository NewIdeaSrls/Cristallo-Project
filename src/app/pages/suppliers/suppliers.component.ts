...
export class SuppliersComponent {
  ...
  datashow = ['supplierCode', 'supplierDescription', 'supplierVatCode', 'supplierPhone', 'supplierEmail'];

  localStorageMDTable: string = 'supplierTable';

  // Configure Fields on Action in accounting
  addfieldsconfig = ['supplierCode', 'supplierDescription', 'supplierVatCode', 'supplierPhone', 'supplierEmail'];
  editfieldsconfig = ['supplierCode', 'supplierDescription', 'supplierVatCode', 'supplierPhone', 'supplierEmail'];
  ...
  getFromRestapi(
    ...
    this.globalService
      ...
      .subscribe((Suppliers: any) => {
        console.log('supplier data: ', Suppliers['data']);
        console.log('supplier length: ', Suppliers['data'].length);
