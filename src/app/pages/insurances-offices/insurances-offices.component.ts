...
export class InsurancesOfficesComponent implements OnInit {
  ...
  localStorageMDTable: string = 'insuranceOfficeTable';
  ...
  getFromRestapi(
    ...
    this.globalService
      ...
      .subscribe((InsuranceOffice: any) => {
        console.log('insuranceOffice data: ', InsuranceOffice['data']);
        console.log('insuranceOffice length: ', InsuranceOffice['data'].length);
